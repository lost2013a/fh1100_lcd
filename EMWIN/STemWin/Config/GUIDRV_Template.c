...
//定义LCD的命令和数据位.
u32 UCGUI_LCD_CMD  = 0x60000000; //地址为0X6C00007E;  0111 1110  FSMC_A6为0 
u32 UCGUI_LCD_DATA = 0X68000002; //地址为0x6C000080;  1000 0000  FSMC_A6为1
/*********************************************************************
*
*       Defines
*
...
static void _DrawBitLine16BPP(GUI_DEVICE * pDevice, int x, int y, U16 const GUI_UNI_PTR * p, int xsize) {
	...
	UI_DrawHColorLine(x, y, xsize, (uint16_t *)p);
//	LCD_PIXELINDEX pixel;
//	LCD_SetCursor(x,y);
//	*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.wramcmd;  //写入颜色值
//	for (;xsize > 0; xsize--, x++, p++) 
